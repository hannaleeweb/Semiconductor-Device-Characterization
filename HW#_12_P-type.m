...
ni=10^10;
Na=10^15; % hole doping concentration (unit:C/m^3)
Nd=0; % electron doping concentration (unit:C/m^3)
me = 1.09;
mh = 1.15;
m0 = 9.10938356 * 10^-31;
...
WF_semi = EA_semi + BG_semi/2 + ((kb*T)/(q*log(Na/ni))); % p-type semi Ei + offsetp;
...
SB = (WF_metal-EA_semi); % p-type semi

W = sqrt(2*perm_a*perm_r*Vbi/(q*Na)); % depletion layer width ptype;
