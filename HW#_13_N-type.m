...
ni=10^10;
Na=0; % hole doping concentration (unit:C/cm^3)
Nd=10^15; % electron doping concentration (unit:C/cm^3)
me = 1.09;
mh = 1.15;
m0 = 9.10938356 * 10^-31;
...
% V-offset in n-type semi
V_offset=kb*T/q * log(Nd/ni); 

% p-type work function of semiconductor, n-type
...
% Depletion layer width of semi, n-type 
W = sqrt(2*perm_a*perm_r*Vbi_mos/(q*Nd)); 
...
% Calculating maximum depletion layer width of semi, n-type 
W_max=sqrt((2*perm_a*perm_r*abs(2*V_offset)/(q*Nd)));
